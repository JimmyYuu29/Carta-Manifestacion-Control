...
class SchemaValidator:
    ...
    def validate_field_value(self, doc_type: str, field_name: str, value: Any) -> Tuple[bool, Optional[str]]:
        """
    ...
    def validate_update(self, doc_type: str, update_data: Dict[str, Any]) -> ValidationResult:
        ...
        3. Returns only the valid, editable fields
        ...
        for field_name, value in update_data.items():
            ...
            is_valid, error_msg = self.validate_field_value(doc_type, field_name, value)
    ...
    def get_schema_for_ui(self, doc_type: str) -> dict:
        ...
        Returns field definitions with editability info
        """
        schema = self.load_schema(doc_type)
